...
// 인덱스 라우트
app.get('/', index.show);
app.get('/login', auth.isLoggedOut, auth.signin);
...
app.get('/signup', auth.isLoggedOut, auth.signup);
...
app.delete('/videos', videos.hasAuthorization, videos.deleteVideo);
...
app.delete('/images', images.hasAuthorization, images.deleteImage);
